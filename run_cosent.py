...
def main(
    ...
    lr_scheduler = get_linear_schedule_with_warmup(optimizer=optimizer, num_warmup_steps=0.05 * total_steps,
    ...
    def cosent_metric_adapter(batch_output, batch) -> MetricModuleUpdateArgs:
        return {
    ...
    metric_strategy = MetricStrategy(
        ...
        metric_adapter=cosent_metric_adapter,
    )
